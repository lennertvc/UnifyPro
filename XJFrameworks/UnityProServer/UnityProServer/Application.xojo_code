		    ...
		    If COM.CoCreateInstance( clsid, nil, COM.CLSCTX_INPROC_SERVER or COM.CLSCTX_LOCAL_SERVER, riid, p ) = 0 then
		      ...
		      If 0 = QueryInterface( COM.IConnectionPointContainer.IID, p ) Then
		        ...
		        If 0 = connPtContainer.FindConnectionPoint( DIApplicationEvents.IID, p ) Then
		          ...
		          mVTable.Ptr(12) = AddressOf Callback_IDispatch_GetTypeInfoCount
		          mVTable.Ptr(16) = AddressOf Callback_IDispatch_GetTypeInfo
		          mVTable.Ptr(20) = AddressOf Callback_IDispatch_GetIDsOfNames
		          mVTable.Ptr(24) = AddressOf Callback_IDispatch_Invoke
		          mVTable.Ptr(28) = AddressOf Callback_BeforeBuildComplete
		          mVTable.Ptr(32) = AddressOf Callback_AfterBuildComplete
		          mVTable.Ptr(36) = AddressOf Callback_WriteAccessAvailable
		          mVTable.Ptr(40) = AddressOf Callback_DisplayStart
		          mVTable.Ptr(44) = AddressOf Callback_DisplayStop
		          mVTable.Ptr(48) = AddressOf Callback_BeforeDownload
		          mVTable.Ptr(52) = AddressOf Callback_AfterDownload
		          mVTable.Ptr(56) = AddressOf Callback_AfterSave
		          mVTable.Ptr(60) = AddressOf Callback_AfterSaveAs
		          mVTable.Ptr(64) = AddressOf Callback_OnLine
		          mVTable.Ptr(68) = AddressOf Callback_OffLine
